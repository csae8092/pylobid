TEST_PERSON_DICTS = [
    ...
    {
        "id": "1069009253",
        "pylobid_born": {"id": "https://d-nb.info/gnd/1028714-0"},
        "pylobid_died": {"id": "https://d-nb.info/gnd/4317058-4"},
    },
    {"id": "136037585", "pylobid_born": {"id": ""}, "pylobid_died": {"id": ""}},
]
...
TEST_UNKNOWN_IDS = ["01234-4321", "0123abc-0123def"]
...
TEST_ORG_NAMES_LOCATIONS = [
    ...
    },
    {
        ...
        "located_in": [{"id": "https://d-nb.info/gnd/4035304-7", "label": "Lemberg"}],
    },
    {
    ...
    },
    {
        ...
        "located_in": [{"id": "https://d-nb.info/gnd/4003614-5", "label": "Augsburg"}],
    },
    {
        "id": "http://d-nb.info/gnd/401873-4",
        "pref_name": "Kaiserlich-Königliches Altstädter Akademisches Gymnasium (Prag)",
        "located_in": [{"id": "https://d-nb.info/gnd/4076310-9", "label": "Prag"}],
    },
    {
        "id": "http://d-nb.info/gnd/1224816-2",
        "pref_name": "Stift Engelszell",
        "located_in": [
            {"id": "https://d-nb.info/gnd/4342017-5", "label": "Engelhartszell"},
            {
    ...
    },
    {
        ...
        "located_in": [
            {"id": "https://d-nb.info/gnd/1048249190", "label": "Schulpforte"}
        ],
    },
]
